    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form class="form-horizontal" role="form" method="POST"  action="{{ route('kurumsalajans.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-md-12 col-md-offset-6">
                                ...
                                <a href="/kurumsalajans" class="btn btn-primary">Geri Al</a>
                            </div>
                        </div>
                    </form>
                </div>
